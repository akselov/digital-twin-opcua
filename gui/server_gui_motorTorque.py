...
current torque on each of the motors controlling the different 
...
if __name__ == "__main__":
    ...
    # Start plot
    xaxis_t0 = 100
    plt.axis([0, xaxis_t0, -1000, 1000])
    plt.title('Current motor torque of KUKA KR 16-2, Axis 1-6')
    plt.grid(True)
    plt.xlabel('time [s*10]')
    plt.ylabel('Current motor torque [Nm]')
    plt.ion()
    count = 0
    ...
    try:
        ...
        while True:
            ...
            plotted_values_A1.append(float(robot.read("$TORQUE_AXIS_ACT [1]")))
            plotted_values_A2.append(float(robot.read("$TORQUE_AXIS_ACT [2]")))
            plotted_values_A3.append(float(robot.read("$TORQUE_AXIS_ACT [3]")))
            plotted_values_A4.append(float(robot.read("$TORQUE_AXIS_ACT [4]")))
            plotted_values_A5.append(float(robot.read("$TORQUE_AXIS_ACT [5]")))
            plotted_values_A6.append(float(robot.read("$TORQUE_AXIS_ACT [6]")))
