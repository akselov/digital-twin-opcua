...
if __name__ == "__main__":
    ...
    try:
        ...
        while(count < timer):
            ...
            values_A1.append(float(robot.read("$VEL_AXIS_ACT [1]"))*10)
            values_A2.append(float(robot.read("$VEL_AXIS_ACT [2]"))*10)
            values_A3.append(float(robot.read("$VEL_AXIS_ACT [3]"))*10)
            values_A4.append(float(robot.read("$VEL_AXIS_ACT [4]"))*10)
            values_A5.append(float(robot.read("$VEL_AXIS_ACT [5]"))*10)
            values_A6.append(float(robot.read("$VEL_AXIS_ACT [6]"))*10)

        f = open('KUKA_KR16_2_motorSpeed.csv', 'w')
