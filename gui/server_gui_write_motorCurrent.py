...
current of each of the motors controlling the different 
KUKA robot axis and writes the data to a .csv file called
"KUKA_KR16_2_motorCurrent.csv".
...
if __name__ == "__main__":
    ...
    try:
        ...
        while(count < timer):
            ...
            values_A1.append(float(robot.read("$CURR_ACT [1]")))
            values_A2.append(float(robot.read("$CURR_ACT [2]")))
            values_A3.append(float(robot.read("$CURR_ACT [3]")))
            values_A4.append(float(robot.read("$CURR_ACT [4]")))
            values_A5.append(float(robot.read("$CURR_ACT [5]")))
            values_A6.append(float(robot.read("$CURR_ACT [6]")))
        
        f = open('KUKA_KR16_2_motorCurrent.csv', 'w')
