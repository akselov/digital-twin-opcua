...
if __name__ == "__main__":
    ...
    try:
        while(True):
            ...
            A1.set_value(robot.read("$AXIS_ACT.A1"))
            A2.set_value(robot.read("$AXIS_ACT.A2"))
            A3.set_value(robot.read("$AXIS_ACT.A3"))
            A4.set_value(robot.read("$AXIS_ACT.A4"))
            A5.set_value(robot.read("$AXIS_ACT.A5"))
            A6.set_value(robot.read("$AXIS_ACT.A6"))
