...
if __name__ == "__main__":
    ...
    try:
        ...
        while(count < timer):
            ...
            values_A1.append(float(robot.read("$TORQUE_AXIS_ACT [1]")))
            values_A2.append(float(robot.read("$TORQUE_AXIS_ACT [2]")))
            values_A3.append(float(robot.read("$TORQUE_AXIS_ACT [3]")))
            values_A4.append(float(robot.read("$TORQUE_AXIS_ACT [4]")))
            values_A5.append(float(robot.read("$TORQUE_AXIS_ACT [5]")))
            values_A6.append(float(robot.read("$TORQUE_AXIS_ACT [6]")))
        
        f = open('KUKA_KR16_2_motorTorque.csv', 'w')
