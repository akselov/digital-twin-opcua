...
current going into each of the motors controlling the different 
...
if __name__ == "__main__":
    ...
    plt.title('Actual Current of Axes KUKA KR 16-2, Axis 1-6')
    plt.grid(True)
    ...
    try:
        ...
        while True:
            ...
            plotted_values_A1.append(float(robot.read("$CURR_ACT [1]")))
            plotted_values_A2.append(float(robot.read("$CURR_ACT [2]")))
            plotted_values_A3.append(float(robot.read("$CURR_ACT [3]")))
            plotted_values_A4.append(float(robot.read("$CURR_ACT [4]")))
            plotted_values_A5.append(float(robot.read("$CURR_ACT [5]")))
            plotted_values_A6.append(float(robot.read("$CURR_ACT [6]")))
